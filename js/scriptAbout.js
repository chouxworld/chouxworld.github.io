...
function background_white() {
    ...
    document.getElementById('wakuAboutText').style.border ='2px solid #000';
    document.getElementById('wakuAboutText').style.color ='#000';
    document.getElementById('wakuAboutText').style.transition ='all 1s';
...
function background_black() {
    ...
    document.getElementById('wakuAboutText').style.border ='2px solid #fff';
    document.getElementById('wakuAboutText').style.color ='#fff';
    document.getElementById('wakuAboutText').style.transition ='all 1s';
